...
export const convertCurrentLocationWitnessForHeatmap: ConvertLocationDataToGeoJsonGeometry<CurrentLocationWitnessPayload, Point, WithHashProperties> = (payload) => {
